    ...
    <div class="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-8 space-y-8">
            ...
            <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" aria-labelledby="create-post-form">
                @csrf
                <div>
                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Title
                        <span class="text-red-500">*</span></label>
                    <input type="text" name="title" id="title" required aria-required="true" class="mt-1 w-full px-4 py-3 rounded border bg-gray-50 shadow border-gray-200 dark:border-gray-700 dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none transition" value="{{ old('title') }}" placeholder="Enter post title">
                    @error('title')
                ...
                <div>
                    ...
                    <div id="editor" class="mt-2 h-48 bg-gray-50 dark:bg-gray-800 border rounded-b p-2 border-gray-200 dark:border-gray-600">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="category" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Category
                            <span class="text-red-500">*</span></label>
                        <select name="category" id="category" required aria-required="true" class="mt-1 w-full px-4 py-3 rounded border bg-gray-50 shadow border-gray-200 dark:border-gray-700 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:outline-none transition">
                    ...
                    <div>
                        <label for="status" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Status
                            <span class="text-red-500">*</span></label>
                        <select name="status" id="status" required aria-required="true" class="mt-1 w-full px-4 py-3 rounded border bg-gray-50 shadow border-gray-200 dark:border-gray-700 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:outline-none transition">
                ...
                <div>
                    ...
                    <input type="file" name="featured_image" id="featured_image" accept="image/*" class="mt-1 w-full px-4 py-2 rounded border bg-gray-50 shadow border-gray-200 dark:border-gray-700 dark:bg-gray-800 text-gray-900 dark:text-gray-100 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-500 file:text-white hover:file:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:outline-none transition" />
                ...
                <div>
                    ...
                    <div id="tag-container" class="mt-1 w-full px-4 py-3 rounded border bg-gray-100 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 flex flex-wrap gap-2">
                        <input type="text" id="tag-input" placeholder="Add tags separated by commas (ex. Laravel, PHP)" class="bg-transparent p-0 flex-1 min-w-[150px]" style="outline: none !important; box-shadow: none !important; border: none !important;" />
                    </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="date" name="created_at" id="created_at" required aria-required="true" class="mt-1 w-full px-4 py-3 rounded border bg-gray-50 shadow border-gray-200 dark:border-gray-700 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:outline-none transition" value="{{ old('created_at', date('Y-m-d')) }}">
                        @error('created_at')
                            <p class="text-red-500 text-sm mt-1" role="alert">{{ $message }}
                            </p>
                        @enderror
                    </div>
